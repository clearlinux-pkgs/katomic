...
Source0  : https://download.kde.org/stable/release-service/21.12.0/src/katomic-21.12.0.tar.xz
...
%prep
%setup -q -n katomic-21.12.0
cd %{_builddir}/katomic-21.12.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1639628187
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/katomic-21.12.0/LICENSES/GFDL-1.2-or-later.txt %{buildroot}/usr/share/package-licenses/katomic/7697008f58568e61e7598e796eafc2a997503fde
cp %{_builddir}/katomic-21.12.0/LICENSES/GPL-2.0-or-later.txt %{buildroot}/usr/share/package-licenses/katomic/3e8971c6c5f16674958913a94a36b1ea7a00ac46
pushd clr-build
%make_install
popd
%find_lang katomic
