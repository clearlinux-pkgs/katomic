...
Version  : 24.02.2
Release  : 67
URL      : https://download.kde.org/stable/release-service/24.02.2/src/katomic-24.02.2.tar.xz
Source0  : https://download.kde.org/stable/release-service/24.02.2/src/katomic-24.02.2.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.02.2/src/katomic-24.02.2.tar.xz.sig
...
%setup -q -n katomic-24.02.2
cd %{_builddir}/katomic-24.02.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1712932768
mkdir -p clr-build
pushd clr-build
