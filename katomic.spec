...
Source0  : https://download.kde.org/stable/release-service/21.04.2/src/katomic-21.04.2.tar.xz
Source1  : https://download.kde.org/stable/release-service/21.04.2/src/katomic-21.04.2.tar.xz.sig
...
%prep
%setup -q -n katomic-21.04.2
cd %{_builddir}/katomic-21.04.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1623366649
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/katomic-21.04.2/LICENSES/GFDL-1.2-or-later.txt %{buildroot}/usr/share/package-licenses/katomic/7697008f58568e61e7598e796eafc2a997503fde
cp %{_builddir}/katomic-21.04.2/LICENSES/GPL-2.0-or-later.txt %{buildroot}/usr/share/package-licenses/katomic/3e8971c6c5f16674958913a94a36b1ea7a00ac46
pushd clr-build
%make_install
popd
%find_lang katomic
