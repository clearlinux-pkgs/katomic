...
Version  : 23.08.4
Release  : 63
URL      : https://download.kde.org/stable/release-service/23.08.4/src/katomic-23.08.4.tar.xz
Source0  : https://download.kde.org/stable/release-service/23.08.4/src/katomic-23.08.4.tar.xz
Source1  : https://download.kde.org/stable/release-service/23.08.4/src/katomic-23.08.4.tar.xz.sig
...
%prep
%setup -q -n katomic-23.08.4
cd %{_builddir}/katomic-23.08.4
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1702966664
mkdir -p clr-build
pushd clr-build
