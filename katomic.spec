...
Source0  : https://download.kde.org/stable/release-service/24.08.0/src/katomic-24.08.0.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.08.0/src/katomic-24.08.0.tar.xz.sig
...
%setup -q -n katomic-24.08.0
cd %{_builddir}/katomic-24.08.0
pushd ..
cp -a katomic-24.08.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1724526026
mkdir -p clr-build
pushd clr-build
