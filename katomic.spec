...
Version  : 23.04.2
Release  : 56
URL      : https://download.kde.org/stable/release-service/23.04.2/src/katomic-23.04.2.tar.xz
Source0  : https://download.kde.org/stable/release-service/23.04.2/src/katomic-23.04.2.tar.xz
Source1  : https://download.kde.org/stable/release-service/23.04.2/src/katomic-23.04.2.tar.xz.sig
...
%prep
%setup -q -n katomic-23.04.2
cd %{_builddir}/katomic-23.04.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1686522986
mkdir -p clr-build
pushd clr-build
