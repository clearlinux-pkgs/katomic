...
Source0  : https://download.kde.org/stable/release-service/23.08.3/src/katomic-23.08.3.tar.xz
Source1  : https://download.kde.org/stable/release-service/23.08.3/src/katomic-23.08.3.tar.xz.sig
...
%prep
%setup -q -n katomic-23.08.3
cd %{_builddir}/katomic-23.08.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1701976572
mkdir -p clr-build
pushd clr-build
