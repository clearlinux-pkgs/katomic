...
%prep
%setup -q -n katomic-19.12.0
cd %{_builddir}/katomic-19.12.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1576357905
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/katomic-19.12.0/COPYING %{buildroot}/usr/share/package-licenses/katomic/4cc77b90af91e615a64ae04893fdffa7939db84c
cp %{_builddir}/katomic-19.12.0/COPYING.DOC %{buildroot}/usr/share/package-licenses/katomic/bd75d59f9d7d9731bfabdc48ecd19e704d218e38
pushd clr-build
%make_install
popd
%find_lang katomic
