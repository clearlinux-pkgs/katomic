...
Version  : 25.04.0
Release  : 82
URL      : https://download.kde.org/stable/release-service/25.04.0/src/katomic-25.04.0.tar.xz
Source0  : https://download.kde.org/stable/release-service/25.04.0/src/katomic-25.04.0.tar.xz
Source1  : https://download.kde.org/stable/release-service/25.04.0/src/katomic-25.04.0.tar.xz.sig
...
%setup -q -n katomic-25.04.0
cd %{_builddir}/katomic-25.04.0
pushd ..
cp -a katomic-25.04.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1744931681
mkdir -p clr-build
pushd clr-build
