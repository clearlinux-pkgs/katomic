...
Source0  : https://download.kde.org/stable/release-service/23.08.2/src/katomic-23.08.2.tar.xz
Source1  : https://download.kde.org/stable/release-service/23.08.2/src/katomic-23.08.2.tar.xz.sig
...
%prep
%setup -q -n katomic-23.08.2
cd %{_builddir}/katomic-23.08.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1697253994
mkdir -p clr-build
pushd clr-build
