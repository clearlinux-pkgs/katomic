...
Version  : 24.02.0
Release  : 65
URL      : https://download.kde.org/stable/release-service/24.02.0/src/katomic-24.02.0.tar.xz
Source0  : https://download.kde.org/stable/release-service/24.02.0/src/katomic-24.02.0.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.02.0/src/katomic-24.02.0.tar.xz.sig
...
%prep
%setup -q -n katomic-24.02.0
cd %{_builddir}/katomic-24.02.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1710301655
mkdir -p clr-build
pushd clr-build
