...
Source0  : https://download.kde.org/stable/release-service/24.12.0/src/katomic-24.12.0.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.12.0/src/katomic-24.12.0.tar.xz.sig
...
%setup -q -n katomic-24.12.0
cd %{_builddir}/katomic-24.12.0
pushd ..
cp -a katomic-24.12.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1735224621
mkdir -p clr-build
pushd clr-build
...
/usr/share/katomic/themes/default.svgz
/usr/share/knsrcfiles/katomic.knsrc
/usr/share/metainfo/org.kde.katomic.appdata.xml
/usr/share/qlogging-categories6/katomic.categories
/usr/share/qlogging-categories6/katomic.renamecategories
...
/usr/share/doc/HTML/sl/katomic/index.cache.bz2
/usr/share/doc/HTML/sl/katomic/index.docbook
